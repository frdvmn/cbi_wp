...
<div class="section articles-sidebar__container">
    <section class="articles">
        ...
        <div class="pagination">
            <a href="" class="pagination__element">Назад</a>
            <a href="" class="pagination__element">1</a>
            <a href="" class="pagination__element active">2</a>
            <a href="" class="pagination__element">3</a>
            <a href="" class="pagination__element">4</a>
            <a href="" class="pagination__element">Далее</a>
        </div>
    </section>
    <aside class="sidebar">
