                    ...
                    <li class="glide__slide">
                        <div class="project-card">
                            <div class="project-card__content">
                                ...
                                <h2 class="project-card__title">Ближний Восток - Европа</h2>
                                <p class="project-card__tags">Руководитель: Ярослав Берестов, Первый Вице-президент,
                                    Член Совета Правления ЦБИ</p>
                                <p class="project-card__description">Специальная программа "Ближний Восток - Европа" в
                                    рамках Центра Ближневосточных исследований направлена на всестороннее изучение
                                    исторических, политических, экономических и культурных взаимодействий стран Ближнего
                                    Востока с европейскими государствами. Основная цель программы – анализ сложившихся и
                                    развивающихся отношений между регионами на протяжении истории, а также оценка
                                    текущих тенденций и вызовов в этих взаимоотношениях.</p>
                                <button data-micromodal-trigger="modal-1" class="btn">Читать далее</button>
                            </div>
                            <img src="/assets/images/test.jpg" alt="Проект" class="project-card__image">
                        </div>
                    </li>
                    <li class="glide__slide">
                        <div class="project-card">
